...
deploy-sepola:
	forge script script/DeployfundMe.s.sol:DeployFundMe --rpc-url $(SAPOLA_TEST_RPC) --private-key $(PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
